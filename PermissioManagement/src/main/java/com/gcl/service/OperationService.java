...
import com.gcl.common.MapperKey;
import com.gcl.common.annotation.Authority;
import com.gcl.common.utils.AnnotationUtil;
import com.gcl.common.utils.JsonConvertUtil;
...
public class OperationService extends AbstratService<AuthOperation> {
	// 扫描包
	private static final String PERMISS_PACKAGE = "com.gcl.controller";
